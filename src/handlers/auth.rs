...
use crate::{config::crypto::{Auth, CryptoService}, db::user::UserRepository, errors::AppError};
...
pub async fn auth (basic: BasicAuth, repository: UserRepository, hashing: Data<CryptoService>) -> AppResponse {
